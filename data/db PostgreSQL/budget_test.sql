...
-- Generated for: budget_test.db (TEST Mandate)
...
-- ============================================
-- IMPORT INSTRUCTIONS FOR TEST MANDATE
-- ============================================
-- 
-- This is the TEST database for development/testing
-- To import your existing data:
--
-- 1. Export from SQLite:
--    sqlite3 data/mandats/budget_test.db ".dump" > test_export.sql
--
-- 2. Adapt the dump (replace AUTOINCREMENT with SERIAL)
--
-- 3. Import to PostgreSQL:
--    psql -d your_db -f budget_test.sql
